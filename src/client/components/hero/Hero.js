		...
		return (
			<div className={`greetings-wrap ${animation ? "slide" : ""}`}>
				...
				<p className="greetings">
					Hi, my name’s Daisho Komiyama and I'm a front-end developer based in Montreal.
					I’ve been a developer for about {new Date().getFullYear() - 2014} years.
					Passionate about solving problems and building tools that makes our lives
					easier. I'm an effective developer who ships code regularly.
				</p>
			</div>
		);
	};
