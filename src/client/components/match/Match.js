...
class Match extends Component {
    ...
    dragStart = event => {
        ...
        setTimeout(() => this.state.currentTag.classList.add("invisible"), 0);
        // this.state.indexFrom = parseInt(
        this.setState({
            indexFrom: parseInt(
    ...
    dragEnter = event => {
        ...
        // );
        this.setState({
            indexTo: parseInt(event.target.getAttribute("data-position"))
        });
        setTimeout(
    ...
    dragDrop = event => {
        ...
        this.dropTags(parseInt(event.target.getAttribute("data-position")));
    ...
    init = () => {
        this.state.spots = document.getElementsByClassName("spot");
        this.state.tags = "";
        ...
        this.setOrder();
        for (let i = 0; i < this.state.tags.length; i++) {
            this.state.tags[i].addEventListener("dragstart", this.dragStart);
            this.state.tags[i].addEventListener("dragend", this.dragEnd);
        }
        for (let i = 0; i < this.state.spots.length; i++) {
            this.state.spots[i].addEventListener("dragover", this.dragOver);
            this.state.spots[i].addEventListener("dragenter", this.dragEnter);
            this.state.spots[i].addEventListener("dragleave", this.dragLeave);
            this.state.spots[i].addEventListener("drop", this.dragDrop);
        }
    };
        ...
        return (
            <section className="dd-container">
                ...
                <div className="spots">
                    ...
                    >
                        <div className="tag" draggable="true" data-element="0">
                    ...
                    <div
                        ...
                        // onDragEnd={this.dragEnd}
                    >
                        <div className="tag" draggable="true" data-element="1">
                    ...
                    <div
                        ...
                        // onDragEnd={this.dragEnd}
                    >
                        <div className="tag" draggable="true" data-element="2">
